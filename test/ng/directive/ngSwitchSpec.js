...
describe('ngSwitch', function () {
  ...
  it('should show all elements between start and end markers that match the current value', inject(function (
    $rootScope,
    $compile
  ) {
    element = $compile(
  ...
  it('should show all default elements between start and end markers when no match', inject(function (
    $rootScope,
    $compile
  ) {
    element = $compile(
  ...
  it('should always display the elements that do not match a switch', inject(function ($rootScope, $compile) {
    element = $compile(
      '<ul ng-switch="select">' +
        '<li>always </li>' +
        '<li ng-switch-when="1">one </li>' +
  ...
  it('should not leak jq data when compiled but not attached to parent when parent is destroyed', inject(function (
    $rootScope,
    $compile
  ) {
    element = $compile(
  ...
  it('should properly support case labels with different numbers of transclude fns', inject(function (
    $rootScope,
    $compile
  ) {
    element = $compile(
  ...
  it('should not trigger a digest after an element is removed', inject(function (
    $$rAF,
    $compile,
    $rootScope,
    $timeout
  ...
  it('should handle changes to the switch value in a digest loop with multiple value matches', inject(function (
    $compile,
    $rootScope
  ) {
  ...
  describe('ngSwitchWhen separator', function () {
    ...
    it('should be possible to use separators that are multiple characters long', inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
