describe('ngIf', function () {
  describe('basic', function () {
    ...
    it('should create a new scope every time the expression evaluates to true', function () {
      ...
      element.append($compile('<div ng-if="value"><span ng-init="value=false"></span></div>')($scope));
      $scope.$apply();
    ...
    it('should play nice with ngInclude on the same element', inject(function ($templateCache) {
      ...
      $scope.value = 'first';
      element.append($compile('<div ng-if="value==\'first\'" ng-include="\'test.html\'"></div>')($scope));
      $scope.$apply();
