describe('ngClass', function () {
  ...
  it('should add new and remove old classes with same names as Object.prototype properties dynamically', inject(function (
    $rootScope,
    $compile
  ) {
    element = $compile('<div class="existing" ng-class="dynClass"></div>')($rootScope);
  ...
  it('should support adding multiple classes via an array mixed with conditionally via a map', inject(function (
    $rootScope,
    $compile
  ) {
  ...
  it('should remove classes when the referenced object is the same but its property is changed', inject(function (
    $rootScope,
    $compile
  ) {
  ...
  it('should support adding multiple classes via a space delimited string inside an array', inject(function (
    $rootScope,
    $compile
  ) {
  ...
  it('should preserve class added post compilation without pre-existing classes"', inject(function (
    $rootScope,
    $compile
  ) {
  ...
  it('should allow ngClassOdd/Even on the same element with overlapping classes', inject(function (
    $compile,
    $rootScope
  ) {
    element = $compile(
  ...
  it('should reapply ngClass when interpolated class attribute changes', inject(function ($compile, $rootScope) {
    element = $compile(
      '<div>' +
  ...
  it('should not mess up class value due to observing an interpolated class attribute', inject(function (
    $rootScope,
    $compile
  ) {
    $rootScope.foo = true;
  ...
  it('should add/remove the correct classes when the expression and `$index` change simultaneously', inject(function (
    $compile,
    $rootScope
  ) {
  ...
  it('should remove the watcher when static array one-time binding', inject(function ($rootScope, $compile) {
    element = $compile('<div ng-class="::[className]"></div>')($rootScope);
  ...
  it('should remove the watcher when static map one-time binding', inject(function ($rootScope, $compile) {
  ...
  it('should track changes of mutating object inside an array', inject(function ($rootScope, $compile) {
    $rootScope.classVar = [{ orange: true }];
    element = $compile('<div ng-class="classVar"></div>')($rootScope);
