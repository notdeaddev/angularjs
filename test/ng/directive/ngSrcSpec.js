...
describe('ngSrc', function () {
  ...
  describe('img[ng-src]', function () {
    ...
    it('should interpolate the expression and bind to src with raw same-domain value', inject(function (
      $compile,
      $rootScope
    ) {
    ...
    it('should interpolate a multi-part expression for img src attribute (which requires the MEDIA_URL context)', inject(function (
      $compile,
      $rootScope
    ) {
  ...
  describe('iframe[ng-src]', function () {
    ...
    it('should interpolate the expression and bind to src with a trusted value', inject(function (
      $compile,
      $rootScope,
      $sce
    ) {
    ...
    it('should NOT interpolate a multi-part expression in a `src` attribute that requires a non-MEDIA_URL context', inject(function (
      $compile,
      $rootScope
    ) {
      expect(function () {
        ...
        '$interpolate',
        'noconcat',
        'Error while interpolating: some/{{id}}\nStrict ' +
