...
describe('ngInclude', function () {
  describe('basic', function () {
    ...
    it('should trust and use literal urls', inject(function ($rootScope, $httpBackend, $compile) {
    ...
    it('should include an external file', inject(putIntoCache('myUrl', '{{name}}'), function ($rootScope, $compile) {
    ...
    it('should support ng-include="src" syntax', inject(
    ...
    it('should NOT use untrusted URL expressions ', inject(
      putIntoCache('myUrl', '{{name}} text'),
    ...
    it('should NOT use mistyped expressions ', inject(
      putIntoCache('myUrl', '{{name}} text'),
      function ($rootScope, $compile, $sce) {
        element = jqLite('<ng:include src="url"></ng:include>');
        jqLite(window.document.body).append(element);
    ...
    it('should fire $includeContentRequested event on scope after making the xhr call', inject(function (
      $rootScope,
      $compile,
      $httpBackend
    ) {
    ...
    it('should fire $includeContentLoaded event on child scope after linking the content', inject(function (
      $rootScope,
      $compile,
      $templateCache
    ) {
    ...
    it('should fire $includeContentError event when content request fails', inject(function (
      $rootScope,
      $compile,
      $httpBackend,
      $templateCache
    ...
    it('should create child scope and destroy old one', inject(function ($rootScope, $compile, $httpBackend) {
    ...
    it('should clear content when error during xhr request', inject(function ($httpBackend, $compile, $rootScope) {
    ...
    describe('autoscroll', function () {
      ...
      beforeEach(inject(putIntoCache('template.html', 'CONTENT'), putIntoCache('another.html', 'CONTENT')));
      ...
      it('should call $anchorScroll if autoscroll evaluates to true', inject(function (
        $rootScope,
        $compile,
        $animate,
        $timeout
      ...
      it('should not call $anchorScroll if autoscroll evaluates to false', inject(function (
        $rootScope,
        $compile,
        $animate,
        $timeout
  ...
  describe('and animations', function () {
    ...
    it('should fire off the enter animation', inject(function ($compile, $rootScope, $templateCache, $animate) {
      var item;
    ...
    it('should fire off the leave animation', inject(function ($compile, $rootScope, $templateCache, $animate) {
      var item;
      $templateCache.put('enter', [200, '<div>data</div>', {}]);
      $rootScope.tpl = 'enter';
      element = $compile(html('<div><div ' + 'ng-include="tpl">' + '</div></div>'))($rootScope);
    ...
    it('should animate two separate ngInclude elements', inject(function (
      $compile,
      $rootScope,
      $templateCache,
      $animate
