...
describe('$$forceReflow', function () {
  ...
  it('should issue a reflow by touching the `domNode.offsetWidth` when a domNode param is provided', inject(function (
    $$forceReflow
  ) {
    var elm = {};
    elm.offsetWidth = 100;
  ...
  it('should issue a reflow by touching the `jqLiteNode[0].offsetWidth` when a jqLite node param is provided', inject(function (
    $$forceReflow
  ) {
    var elm = {};
    elm.offsetWidth = 200;
  ...
  describe('$animate with ngAnimateMock', function () {
    ...
    it('should keep track of how many reflows have been issued', inject(function ($$forceReflow, $animate) {
      var elm = {};
      elm.offsetWidth = 10;
