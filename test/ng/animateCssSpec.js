...
describe('$animateCss', function () {
  ...
  describe('without animation', function () {
    ...
    it('should apply the provided [addClass] CSS classes to the element after the first frame', inject(function (
      $animateCss
    ) {
    ...
    it('should apply the provided [removeClass] CSS classes to the element after the first frame', inject(function (
      $animateCss
    ) {
    ...
    it('should only resolve the promise once both a digest and RAF have passed after start', inject(function (
      $animateCss,
      $rootScope
    ) {
    ...
    it('should resolve immediately if runner.end() is called', inject(function ($animateCss, $rootScope) {
      var doneSpy = jasmine.createSpy();
      var runner = $animateCss(element, { addClass: 'cool' }).start();
    ...
    it('should reject immediately if runner.end() is called', inject(function ($animateCss, $rootScope) {
    ...
    it('should not resolve after the next frame if the runner has already been cancelled', inject(function (
      $animateCss,
      $rootScope
    ) {
      var doneSpy = jasmine.createSpy();
    ...
    it('should not bother applying the provided [from] and [to] styles to the element if [cleanupStyles] is present', inject(function (
      $animateCss,
      $rootScope
    ) {
