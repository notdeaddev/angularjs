...
describe('$$animateAsyncRun', function () {
  ...
  it('should immediately fire the callback if a RAF has passed since construction', inject(function (
    $$animateAsyncRun,
    $$rAF
  ) {
    var trigger = $$animateAsyncRun();
...
describe('$$AnimateRunner', function () {
  ...
  they(
    "should trigger the inner runner's host $prop function",
    ['end', 'cancel', 'pause', 'resume'],
    function (method) {
      inject(function ($$AnimateRunner) {
        var host = {};
        var spy = (host[method] = jasmine.createSpy());
  ...
  it('should resolve the done function only if one RAF has passed', inject(function ($$AnimateRunner, $$rAF) {
  ...
  it('should resolve with the status provided in the completion function', inject(function ($$AnimateRunner, $$rAF) {
    var runner = new $$AnimateRunner();
    var capturedValue;
  ...
  they(
    'should immediately resolve each combined runner in a bottom-up order when $prop is called',
    ['end', 'cancel'],
    function (method) {
      inject(function ($$AnimateRunner) {
        var runner1 = new $$AnimateRunner();
  ...
  they(
    'should resolve/reject using a newly created promise when .then() is used upon $prop',
    ['end', 'cancel'],
    function (method) {
  ...
  it('should expose/create the contained promise when getPromise() is called', inject(function (
    $$AnimateRunner,
    $rootScope
  ) {
    var runner = new $$AnimateRunner();
  ...
  it('should expose the `catch` promise function to handle the rejected state', inject(function (
    $$AnimateRunner,
    $rootScope
  ) {
    var runner = new $$AnimateRunner();
  ...
  they(
    'should expose the `finally` promise function to handle the final state when $prop',
    { rejected: 'cancel', resolved: 'end' },
    function (method) {
      inject(function ($$AnimateRunner, $rootScope) {
        var runner = new $$AnimateRunner();
  ...
  describe('.all()', function () {
    it('should resolve when all runners have naturally resolved', inject(function ($$rAF, $$AnimateRunner) {
      var runner1 = new $$AnimateRunner();
      var runner2 = new $$AnimateRunner();
    ...
    they(
      'should immediately resolve if and when all runners have been $prop',
      { ended: 'end', cancelled: 'cancel' },
      function (method) {
        inject(function ($$AnimateRunner) {
          var runner1 = new $$AnimateRunner();
          var runner2 = new $$AnimateRunner();
    ...
    it('should return a status of `false` if one or more runners was cancelled', inject(function ($$AnimateRunner) {
      var runner1 = new $$AnimateRunner();
      var runner2 = new $$AnimateRunner();
      var runner3 = new $$AnimateRunner();
  ...
  describe('.chain()', function () {
    it('should evaluate an array of functions in a chain', inject(function ($$rAF, $$AnimateRunner) {
      var runner1 = new $$AnimateRunner();
      var runner2 = new $$AnimateRunner();
      var runner3 = new $$AnimateRunner();
    ...
    it('should break the chain when a function evaluates to false', inject(function ($$rAF, $$AnimateRunner) {
      var runner1 = new $$AnimateRunner();
      var runner2 = new $$AnimateRunner();
      var runner3 = new $$AnimateRunner();
