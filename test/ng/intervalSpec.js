describe('$interval', function () {
  ...
  it('should call $apply after each task is executed', inject(function ($interval, $rootScope, $window) {
  ...
  it('should NOT call $apply if invokeApply is set to false', inject(function ($interval, $rootScope, $window) {
    var applySpy = spyOn($rootScope, '$apply').and.callThrough();
  ...
  it('should NOT call $evalAsync or $digest if invokeApply is set to false', inject(function (
    $interval,
    $rootScope,
    $window,
    $timeout
  ...
  it('should return a promise which will be updated with the count on each iteration', inject(function (
    $interval,
    $window
  ) {
    var log = [],
  ...
  describe('exception handling', function () {
    ...
    it('should delegate exception to the $exceptionHandler service', inject(function (
      $interval,
      $exceptionHandler,
      $window
    ) {
    ...
    it('should call $apply even if an exception is thrown in callback', inject(function (
      $interval,
      $rootScope,
      $window
    ) {
    ...
    it('should still update the interval promise when an exception is thrown', inject(function ($interval, $window) {
      var log = [],
        promise = $interval(function () {
          throw 'Some Error';
        }, 1000);
  ...
  describe('cancel', function () {
    ...
    it('should return true if a task was successfully canceled', inject(function ($interval, $window) {
      var task1 = jasmine.createSpy('task1'),
        task2 = jasmine.createSpy('task2'),
        promise1,
        promise2;
    ...
    it('should throw an error when given a non-$interval promise', inject(function ($interval) {
      ...
      expect(function () {
        $interval.cancel(promise);
      }).toThrowMinErr('$interval', 'badprom');
    }));
