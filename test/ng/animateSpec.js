describe('$animate', function () {
  describe('without animation', function () {
    ...
    it('should enter the element to the start of the parent container', inject(function (
      $animate,
      $compile,
      $rootScope
    ) {
    ...
    it('should apply styles instantly to the element', inject(function ($animate, $compile, $rootScope) {
    ...
    it('should still perform DOM operations even if animations are disabled (post-digest)', inject(function (
      $animate,
      $rootScope
    ) {
    ...
    it('should merge the from and to styles that are provided', inject(function ($animate, $rootScope) {
      var element = jqLite('<div></div>');
    ...
    it('should avoid cancelling out add/remove when the element already contains the class', inject(function (
      $animate,
      $rootScope
    ) {
    ...
    it('should avoid cancelling out remove/add if the element does not contain the class', inject(function (
      $animate,
      $rootScope
    ) {
      var element = jqLite('<div></div>');
    ...
    they('should accept an unwrapped "parent" element for the $prop event', ['enter', 'move'], function (method) {
    ...
    they('should accept an unwrapped "after" element for the $prop event', ['enter', 'move'], function (method) {
      inject(function ($document, $animate, $rootElement) {
        var element = jqLite('<div></div>');
  ...
  describe('CSS class DOM manipulation', function () {
    ...
    it('should defer class manipulation until postDigest when outside of digest', inject(function (
      $rootScope,
      $animate,
      log
    ) {
    ...
    it('should perform class manipulation in expected order at end of digest', inject(function (
      $rootScope,
      $animate,
      log
    ) {
    ...
    it('should return a promise which is resolved on a different turn', inject(function (
      log,
      $animate,
      $$rAF,
      $rootScope
    ...
    it('should defer class manipulation until postDigest when outside of digest for SVG', inject(function (
      $rootScope,
      $animate,
      log
    ) {
    ...
    it('should perform class manipulation in expected order at end of digest for SVG', inject(function (
      $rootScope,
      $animate,
      log
    ) {
