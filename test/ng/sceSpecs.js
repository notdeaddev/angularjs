...
describe('SCE', function () {
  ...
  describe('when enabled', function () {
    it('should wrap string values with TrustedValueHolder', inject(function ($sce) {
      ...
      }).toThrowMinErr('$sce', 'unsafe', 'Attempting to use an unsafe value in a safe context.');
    ...
    it('should NOT wrap unknown contexts', inject(function ($sce) {
      expect(function () {
        ...
        '$sce',
        'icontext',
        'Attempted to trust a value in invalid context. Context: unknown1; Value: 123'
      );
    }));
    ...
    it('should NOT wrap undefined context', inject(function ($sce) {
      expect(function () {
        ...
        '$sce',
        'icontext',
        'Attempted to trust a value in invalid context. Context: undefined; Value: 123'
      );
    }));
    ...
    it('should NOT unwrap values that had not been wrapped', inject(function ($sce) {
      ...
      expect(function () {
        return $sce.getTrusted($sce.HTML, wrappedValue);
      }).toThrowMinErr('$sce', 'unsafe', 'Attempting to use an unsafe value in a safe context.');
    }));
  ...
  describe('$sceDelegate resource url policies', function () {
    ...
    it(
      'should default to "self" which allows relative urls',
      runTest({}, function ($sce, $document) {
        expect($sce.getTrustedResourceUrl('foo/bar')).toEqual('foo/bar');
      })
    );

    it(
      'should reject everything when trusted resource URL list is empty',
      runTest(
        {
          trustedUrls: [],
          bannedUrls: []
    ...
    it(
      'should match against normalized urls',
      runTest(
        {
          trustedUrls: [/^foo$/],
          bannedUrls: []
        ...
        function ($sce) {
          expect(function () {
            ...
            '$sce',
            'insecurl',
            'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: foo'
          );
        }
      )
    );
        ...
        runTest(
          ...
          function ($sce) {
            ...
            expect(function () {
              ...
              '$sce',
              'insecurl',
              'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: https://example.com/foo'
            );
        ...
        runTest(
          ...
          function ($sce) {
            ...
            expect(function () {
              ...
              '$sce',
              'insecurl',
              'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: http://example.com/fo'
            );
            ...
            expect(function () {
              ...
              '$sce',
              'insecurl',
              'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: http://example.com/foo2'
            );
            ...
            expect(function () {
              ...
              '$sce',
              'insecurl',
              'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: xhttp://example.com/foo'
            );
          }
        )
      );
    ...
    describe('string matchers', function () {
      it(
        'should support strings as matchers',
        runTest(
          {
          ...
          function ($sce) {
            ...
            expect(function () {
              ...
              '$sce',
              'insecurl',
              'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: http://example-com/foo'
            );
        ...
        runTest(
          ...
          function ($sce) {
            ...
            expect(function () {
              ...
              '$sce',
              'insecurl',
              'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: http://example-com/foo:bar'
            );
            // The * wildcard does not match '/'
            expect(function () {
              $sce.getTrustedResourceUrl('http://example-com/foo/bar');
      ...
      it(
        ...
        runTest(
          ...
          function ($sce) {
            ...
            expect($sce.getTrustedResourceUrl('http://example.com/foo:1/2.3?4&5-6')).toEqual(
              'http://example.com/foo:1/2.3?4&5-6'
            );
          }
        )
      );
    ...
    describe('"self" matcher', function () {
      it(
        'should support the special string "self" in trusted resource URL list',
        runTest(
          {
            trustedUrls: ['self'],
            bannedUrls: []
      ...
      it(
        'should support the special string "self" in baneed resource URL list',
        runTest(
          {
            trustedUrls: [/.*/],
            bannedUrls: ['self']
      ...
      describe('when the document base URL has changed', function () {
        ...
        it(
          ...
          runTest(cfg, function ($sce) {
            expect($sce.getTrustedResourceUrl('foo')).toEqual('foo');
          })
        );

        it(
          'should allow absolute URLs',
          runTest(cfg, function ($sce) {
    ...
    it(
      'should have the banned resource URL list override the trusted resource URL list',
      runTest(
        {
          trustedUrls: ['self'],
          bannedUrls: ['self']
    ...
    it(
      'should support multiple items in both lists',
      runTest(
        {
        ...
        function ($sce) {
          ...
          expect(function () {
            ...
            '$sce',
            'insecurl',
            'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: http://example.com/3'
          );
          expect(function () {
            ...
            '$sce',
            'insecurl',
            'Blocked loading resource from url not allowed by $sceDelegate policy.  URL: open_redirect'
          );
        }
      )
    );
