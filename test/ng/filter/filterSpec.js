describe('Filter: filter', function () {
  ...
  it('should match primitive array values against top-level `$` property in object expression', function () {
    var items, expr;
  ...
  it('should match items with array properties containing one or more matching items', function () {
    ...
    items = [{ nums: [1, 345, 12] }, { nums: [0, 46, 78] }, { nums: [123, 4, 67] }];
    expr = { nums: 12 };
    expect(filter(items, expr).length).toBe(2);
    expect(filter(items, expr)).toEqual([items[0], items[2]]);
  ...
  it('should allow specifying the special "match-all" property', function () {
    var items = [{ foo: 'baz' }, { bar: 'baz' }, { '%': 'no dollar' }];
  ...
  it('should ignore function properties in items', function () {
    ...
    var items = [{ text: 'hello', func: noop }, { text: 'goodbye' }, { text: 'kittens' }, { text: 'puppies' }];
    var expr = { text: 'hello' };
    ...
    items = [new Item('hello'), new Item('goodbye'), new Item('kittens'), new Item('puppies')];
  ...
  it('should ignore function properties in expression', function () {
    // Own function properties
    var items = [{ text: 'hello' }, { text: 'goodbye' }, { text: 'kittens' }, { text: 'puppies' }];
  ...
  it('should consider inherited properties in items', function () {
    ...
    var items = [new Item('hello'), new Item('goodbye'), new Item('kittens'), new Item('puppies')];
  ...
  it('should consider inherited properties in expression', function () {
    ...
    var items = [{ text: 'hello', doubleL: true }, { text: 'goodbye' }, { text: 'kittens' }, { text: 'puppies' }];
    var expr = new Expr('e');
  ...
  it('should not be affected by `Object.prototype` when using a string expression', function () {
    ...
    var items = [createMap(), createMap(), createMap(), createMap()];
  ...
  describe('should support comparator', function () {
    it('not convert `null` or `undefined` to string in non-strict comparison', function () {
      var items = [{ value: null }, { value: undefined }];
      var flt = { value: 'u' };
