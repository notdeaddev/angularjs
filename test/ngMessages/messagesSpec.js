describe('ngMessages', function () {
  ...
  it('should display the elements in the order defined in the DOM', inject(function ($rootScope, $compile) {
    element = $compile(
      '<div ng-messages="col">' +
  ...
  it('should be compatible with ngBind', inject(function ($rootScope, $compile) {
    element = $compile(
      '<div ng-messages="col">' +
  ...
  describe('when including templates', function () {
    ...
    it('should re-render the messages after download without an extra digest', inject(function (
      ...
      $httpBackend
        ...
        .respond(201, '<div ng-message="required">You did not enter a value</div>');
    ...
    it('should not throw if the template is empty', inject(function ($compile, $rootScope, $templateCache) {
      var html =
        '<div ng-messages="items">' +
