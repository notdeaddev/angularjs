describe('resource', function () {
  ...
  describe('basic usage', function () {
    ...
    describe('lookupDottedPath', function () {
      ...
      it('should throw for invalid path', function () {
        ...
        }).toThrowMinErr('$resource', 'badmember', 'Dotted member path "@.ckck" is invalid.');
      });
    ...
    it('should post charge verb on instance', function () {
      $httpBackend
        .expect('POST', '/CreditCard/123!charge?amount=10', '{"id":{"key":123},"name":"misko"}')
        .respond({ success: 'ok' });
    ...
    it('should pass resource object to dynamic default parameters', function () {
      ...
      $httpBackend.expect('GET', '/Person/fedor').respond({ id: 'fedor', email: 'f@f.com', count: 1 });
      ...
      $httpBackend.expect('POST', '/Person/fedor2').respond({ id: 'fedor2', email: 'f2@f.com', count: 2 });
    ...
    describe('promise api', function () {
      ...
      describe('requestInterceptor', function () {
        ...
        it('should call $http with the value returned from requestInterceptor', function () {
          ...
          $httpBackend.flush();
          expect(successSpy).toHaveBeenCalledOnceWith(jasmine.arrayContaining([jasmine.objectContaining({ id: 1 })]));
          expect(failureSpy).not.toHaveBeenCalled();
        });
  ...
  describe('handling rejections', function () {
    ...
    it('should report a PUR when the responseError interceptor returns a rejected promise', inject(function ($q) {
      var CreditCard = $resource(
        '/CreditCard',
        {},
        {
  ...
  describe('cancelling requests', function () {
    ...
    it('should delete non-numeric timeouts in actions and log a $debug message', inject(function ($log, $q) {
      spyOn($log, 'debug');
      $httpBackend.whenGET('/CreditCard').respond({});
