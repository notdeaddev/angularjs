...
describe('injector', function () {
  ...
  beforeEach(
    module(function ($provide, $injector, $controllerProvider) {
  ...
  it('should resolve dependency graph and instantiate all services just once', function () {
    ...
    providers('s5', function () {
      log.push('s5');
      return {};
    });
    providers('s6', function () {
      log.push('s6');
      return {};
    });
  ...
  it('should provide path to the missing provider', function () {
    providers('a', function (idontexist) {
      return 1;
    });
    providers('b', function (a) {
      return 2;
    });
    expect(function () {
      injector.get('b');
  ...
  describe('loadNewModules', function () {
    ...
    it('should execute runBlocks of new modules', function () {
      var log = [];
      angular.module('initial', []).run(function () {
        log.push('initial');
      });
      var injector = createInjector(['initial']);
      log.push('created');
    ...
    it('should execute configBlocks of new modules', function () {
      var log = [];
      angular.module('initial', []).config(function () {
        log.push('initial');
      });
      var injector = createInjector(['initial']);
      log.push('created');
    ...
    it('should not reload a module that is already loaded', function () {
      ...
      angular.module('b', ['a']).run(function () {
        log.push('b');
      });
      angular.module('c', []).run(function () {
        log.push('c');
      });
      angular.module('d', ['b', 'c']).run(function () {
        log.push('d');
      });
  ...
  describe('invoke', function () {
    ...
    it('should invoke the passed-in fn with all of the dependencies as arguments', function () {
      providers('c', function () {
        return 3;
      });
      providers('d', function () {
        return 4;
      });
  ...
  describe('annotation', function () {
    ...
    describe('es6', function () {
      ...
      if (support.classes) {
        ...
        they(
          'should detect ES6 classes regardless of whitespace/comments ($prop)',
          [
            'class Test {}',
            'class Test{}',
            'class //<--ES6 stuff\nTest {}',
  ...
  describe('module', function () {
    ...
    it('should load dependant modules only once', function () {
      ...
      angular.module('b', ['a'], function () {
        log += 'b';
      });
      angular.module('c', ['a', 'b'], function () {
        log += 'c';
      });
      createInjector(['c', 'c']);
    ...
    it('should load different instances of dependent functions', function () {
      ...
      var injector = createInjector([generateValueModule('name1', 'value1'), generateValueModule('name2', 'value2')]);
    ...
    describe('$provide', function () {
      ...
      describe('decorator', function () {
        ...
        it('should be called with the original instance', function () {
          ...
          log.push(out);
          expect(log.join('; ')).toBe('myDecoratedService:input; myService:decInput; dec+origReturn');
        });
        ...
        it('should decorate services with dependencies', function () {
          ...
          var out = injector.get('myService')('input');
          log.push(out);
          expect(log.join('; ')).toBe('myDecoratedService:input; myService:decInput,dependency1; dec+origReturn');
        });
        ...
        it('should allow for decorators to be injectable', function () {
          ...
          var out = injector.get('myService')('input');
          log.push(out);
          expect(log.join('; ')).toBe('myDecoratedService:input,dependency1; myService:decInput; dec+origReturn');
        });
  ...
  describe('retrieval', function () {
    ...
    it('should cache instance', function () {
      var $injector = createInjectorWithFactory('instance', function () {
        return new Instance();
      });
