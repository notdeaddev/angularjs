describe('ngAnimate integration tests', function () {
  ...
  it('should cancel a running and started removeClass animation when a follow-up addClass animation adds the same class', inject(function (
    $animate,
    $rootScope,
    $$rAF,
    $document,
  ...
  it('should remove a class that is currently being added by a running animation when another class is added in before in the same digest', inject(function (
    $animate,
    $rootScope,
    $$rAF,
    $document,
  ...
  it('should add a class that is currently being removed by a running animation when another class is removed before in the same digest', inject(function (
    $animate,
    $rootScope,
    $$rAF,
    $document,
  ...
  describe('CSS animations', function () {
    ...
    it('should only create a single copy of the provided animation options', inject(function (
      $rootScope,
      $rootElement,
      $animate
    ) {
    ...
    they(
      'should render an $prop animation',
    ...
    it('should not throw an error if the element is orphaned before the CSS animation starts', inject(function (
      $rootScope,
      $rootElement,
      $animate
    ) {
    ...
    it('should include the added/removed classes in lieu of the enter animation', inject(function (
      $animate,
      $compile,
      $rootScope,
      $rootElement,
    ...
    it('should animate ng-class and a structural animation in parallel on the same element', inject(function (
      $animate,
      $compile,
      $rootScope,
      $rootElement,
    ...
    it('should trigger callbacks at the start and end of an animation', inject(function (
      $rootScope,
      $rootElement,
      $animate,
      $compile
    ...
    it('should remove a class when the same class is currently being added by a joined class-based animation', inject(function (
      $animate,
      $animateCss,
      $rootScope,
      $document,
      ...
      browserTrigger(element, 'transitionend', { timeStamp: Date.now() + 1000, elapsedTime: 2 });
      $animate.flush();
    ...
    it('should handle ng-if & ng-class with a class that is removed before its add animation has concluded', function () {
      inject(function ($animate, $rootScope, $compile, $timeout, $$rAF) {
        ...
        element = jqLite(
          '<section><div ng-if="true" class="animate-me" ng-class="{' +
            'red: red,' +
            'blue: blue' +
            '}"></div></section>'
        );
  ...
  describe('JS animations', function () {
    ...
    they(
      "should not wait for a parent's classes to resolve if a $prop is animation used for children",
      ['beforeAddClass', 'beforeRemoveClass', 'beforeSetClass'],
      function (phase) {
    ...
    they(
      "should have the parent's classes already applied in time for the children if $prop is used",
