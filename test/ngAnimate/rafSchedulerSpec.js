describe('$$rAFScheduler', function () {
  ...
  it('should accept an array of tasks and run the first task immediately', inject(function ($$rAFScheduler) {
  ...
  it('should run tasks based on how many RAFs have run in comparison to the task index', inject(function (
    $$rAFScheduler,
    $$rAF
  ) {
    var i,
  ...
  it('should space out subarrays by a RAF and run the internals in parallel', inject(function ($$rAFScheduler, $$rAF) {
    var spies = {
      a: jasmine.createSpy(),
      b: jasmine.createSpy(),
      c: jasmine.createSpy(),
  ...
  describe('.waitUntilQuiet', function () {
    it('should run the `last` provided function when a RAF fully passes', inject(function ($$rAFScheduler, $$rAF) {
    ...
    it('should always execute itself before the next RAF task tick occurs', function () {
      ...
      inject(function ($$rAFScheduler, $$rAF, log) {
        ...
        var tasks = [[log.fn('task1')], [log.fn('task2')], [log.fn('task3')], [log.fn('task4')]];
