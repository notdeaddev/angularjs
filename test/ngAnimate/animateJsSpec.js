...
describe('ngAnimate $$animateJs', function () {
  ...
  they(
    'should $prop all of the running the animations when runner.$prop() is called',
    ['end', 'cancel'],
    function (method) {
      var lookup = {};
      module(function ($animateProvider) {
  ...
  they(
    'should still run the associated DOM event when the $prop function is run but no more animations',
    ['cancel', 'end'],
    function (method) {
      var log = [];
      module(function ($animateProvider) {
      ...
      inject(function ($$animateJs, $animate) {
        ...
        $animate.flush();
        expect(log).toEqual(['before addClass ' + method, 'dom addClass', 'addClass complete']);
      });
    }
  );
  ...
  describe('events', function () {
    ...
    they(
      '$prop should have the function signature of (element, done, options) for the after animation',
      ['enter', 'move', 'leave'],
      function (event) {
        inject(function () {
          var args;
    ...
    they(
      '$prop should have the function signature of (element, className, done, options) for the before animation',
    ...
    they(
      '$prop should have the function signature of (element, className, done, options) for the after animation',
      ['addClass', 'removeClass'],
      function (event) {
        inject(function () {
          var args;
    ...
    they(
      'setClass should have the function signature of (element, addClass, removeClass, done, options) for the $prop animation',
      ['before', 'after'],
      function (event) {
        inject(function () {
          var args;
    ...
    they(
      'animate should have the function signature of (element, from, to, done, options) for the $prop animation',
      ['before', 'after'],
      function (event) {
        inject(function () {
          var args;
    ...
    they(
      'custom events should have the function signature of (element, done, options) for the $prop animation',
      ['before', 'after'],
      function (event) {
        inject(function () {
          var args;
    ...
    they(
      '$prop should asynchronously render the $prop animation when a start/end animator object is returned',
      allEvents,
      function (event) {
    ...
    they(
      '$prop should asynchronously render the $prop animation when an instance of $$AnimateRunner is returned',
      allEvents,
      function (event) {
        inject(function ($animate, $$AnimateRunner) {
          var runner;
    ...
    they(
      '$prop should asynchronously reject the before animation if the callback function is called with false',
      otherEvents,
      function (event) {
    ...
    they(
      '$prop should asynchronously reject the after animation if the callback function is called with false',
      allEvents,
      function (event) {
        inject(function ($animate, $rootScope) {
          animations[event] = function (element, a, b, c) {
    ...
    it('beforeSetClass should delegate down to beforeAddClass/beforeRemoveClass if not defined', inject(function (
      $animate
    ) {
    ...
    it('leave should always ignore the `beforeLeave` animation', inject(function ($animate) {
    ...
    it('should allow custom events to be triggered', inject(function ($animate) {
