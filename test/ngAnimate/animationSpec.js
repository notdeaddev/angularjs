describe('$$animation', function () {
  ...
  it('should not run an animation if there are no drivers', inject(function ($$animation, $animate, $rootScope) {
  ...
  describe('drivers', function () {
    ...
    describe('step function', function () {
      ...
      it('should obtain the element, event, the provided options and the domOperation', inject(function (
        $$animation,
        $rootScope,
        $rootElement
      ) {
      ...
      it('should obtain the classes string which is a combination of className, addClass and removeClass', inject(function (
        $$animation,
        $rootScope,
        $rootElement
      ) {
    ...
    they(
      'should $prop the animation call if the driver $proped the returned promise',
      ['resolve', 'reject'],
      function (event) {
        module(function ($$animationProvider, $provide) {
    ...
    they('should $prop the driver animation when runner.$prop() is called', ['cancel', 'end'], function (method) {
      var log = [];
  ...
  describe('when', function () {
    ...
    describe('singular', function () {
      ...
      it('should space out multiple ancestorial class-based animations with a RAF in between', inject(function (
        $rootScope,
        $$animation,
        $$rAF
      ) {
      ...
      it('should properly cancel out pending animations that are spaced with a RAF request before the digest completes', inject(function (
        $rootScope,
        $$animation,
        $$rAF
      ) {
      ...
      it('should properly cancel out pending animations that are spaced with a RAF request after the digest completes', inject(function (
        $rootScope,
        $$animation,
        $$rAF
      ) {
      ...
      they(
        'should return a runner that object that contains a $prop() function',
        ['end', 'cancel', 'then'],
        function (method) {
      ...
      they(
        'should close the animation if runner.$prop() is called before the $postDigest phase kicks in',
        ['end', 'cancel'],
        function (method) {
          inject(function ($$animation, $rootScope, $animate) {
            var status;
      ...
      they(
        'should update the runner methods to the ones provided by the driver when the animation starts',
        ['end', 'cancel'],
        function (method) {
      ...
      it('should not start the animation if the element is removed from the DOM before the postDigest kicks in', inject(function (
        $$animation
      ) {
        var runner = $$animation(element, 'someEvent');
      ...
      it('should immediately end the animation if the element is removed from the DOM during the animation', inject(function (
        $$animation,
        $animate,
        $rootScope
      ) {
      ...
      it('should not end the animation when the leave animation removes the element from the DOM', inject(function (
        $$animation,
        $animate,
        $rootScope
      ) {
      ...
      it('should remove the $destroy event listener when the animation is closed', inject(function (
        $$animation,
        $rootScope
      ) {
      ...
      it('should always sort parent-element animations to run in order of parent-to-child DOM structure', inject(function (
        $$animation,
        $rootScope,
        $animate
      ) {
      ...
      they(
        'should only apply the ng-$prop-prepare class if there are a child animations',
        ['enter', 'leave', 'move'],
      ...
      they(
        'should remove the preparation class before the $prop-animation starts',
        ['enter', 'leave', 'move'],
        function (animationType) {
    ...
    describe('grouped', function () {
      ...
      beforeEach(
        module(function ($provide) {
          ...
          fromAnchors = [jqLite('<div>1</div>'), jqLite('<div>2</div>'), jqLite('<div>3</div>')];
          toAnchors = [jqLite('<div>a</div>'), jqLite('<div>b</div>'), jqLite('<div>c</div>')];
      ...
      it('should group animations together when they have shared anchors and a shared CSS class', inject(function (
        $$animation,
        $rootScope
      ) {
      ...
      it('should group animations together and properly match up multiple anchors based on their references', inject(function (
        $$animation,
        $rootScope
      ) {
      ...
      it('should group animations together on the from and to elements if their both contain matching anchors', inject(function (
        $$animation,
        $rootScope
      ) {
        fromElement.addClass('shared-class');
      ...
      it('should not group animations into an anchored animation if enter/leave events are NOT used', inject(function (
        $$animation,
        $rootScope,
        $$rAF
      ) {
      ...
      it('should not group animations together if a matching pair of anchors is not detected', inject(function (
        $$animation,
        $rootScope
      ) {
        fromElement.addClass('shared-class');
      ...
      it('should not group animations together if a matching CSS class is not detected', inject(function (
        $$animation,
        $rootScope
      ) {
      ...
      it('should expose the shared CSS class in the options provided to the driver', inject(function (
        $$animation,
        $rootScope
      ) {
      ...
      it('should update the runner methods to the grouped runner methods handled by the driver', inject(function (
        $$animation,
        $rootScope
      ) {
      ...
      they(
        'should end the animation if the $prop element is prematurely removed from the DOM during the animation',
        ['from', 'to'],
        function (event) {
      ...
      it('should not end the animation when the `from` animation calls its own leave dom operation', inject(function (
        $$animation,
        $rootScope
      ) {
        fromElement.addClass('group-1');
      ...
      it('should not end the animation if any of the anchor elements are removed from the DOM during the animation', inject(function (
        $$animation,
        $rootScope
      ) {
        fromElement.addClass('group-1');
      ...
      it('should prepare a parent-element animation to run first before the anchored animation', inject(function (
        $$animation,
        $rootScope,
        $rootElement,
        $animate
  ...
  describe('[options]', function () {
    ...
    it('should temporarily assign the provided CSS class for the duration of the animation', inject(function (
      $rootScope,
      $$animation
    ) {
      parent.append(element);
    ...
    it('should add and remove the ng-animate CSS class when the animation is active', inject(function (
      $$animation,
      $rootScope
    ) {
      parent.append(element);
    ...
    it("should perform the DOM operation at the end of the animation if the driver doesn't run it already", inject(function (
      $$animation,
      $rootScope
    ) {
      parent.append(element);
