...
describe('errors', function () {
  ...
  describe('errorHandlingConfig', function () {
    describe('objectMaxDepth', function () {
      ...
      they(
        'should set objectMaxDepth to NaN when $prop is supplied',
        [NaN, null, true, false, -1, 0],
        function (maxDepth) {
  ...
  describe('minErr', function () {
    ...
    it('should interpolate non-string arguments', function () {
      ...
      myError = testError('26', 'arr: {0}; obj: {1}; anonFn: {2}; namedFn: {3}', arr, obj, anonFn, namedFn);
    ...
    they(
      'should handle arguments that are objects and ignore max depth when objectMaxDepth = $prop',
      [NaN, null, true, false, -1, 0],
      function (maxDepth) {
        var a = { b: { c: { d: { e: { f: { g: 1 } } } } } };
    ...
    it('should include a properly formatted error reference URL in the message', function () {
      ...
      expect(testError('acode', 'aproblem', 'a', 'b', 'value with space').message).toMatch(
