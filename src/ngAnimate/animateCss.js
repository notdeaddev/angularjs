      ...
      function (
        ...
        return function init(element, initialOptions) {
          ...
          flags.applyTransitionDelay =
            truthyTimingValue(options.delay) && (flags.applyTransitionDuration || flags.hasTransitions);
          ...
          if (!options.skipBlocking) {
            ...
            flags.blockKeyframeAnimation =
              timings.animationDuration > 0 && stagger.animationDelay > 0 && stagger.animationDuration === 0;
          }
          ...
          function start() {
            ...
            function triggerAnimationStart() {
              ...
              if (flags.applyAnimationDelay) {
                relativeDelay =
                  typeof options.delay !== 'boolean' && truthyTimingValue(options.delay)
