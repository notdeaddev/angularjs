        ...
        function resourceFactory(url, paramDefaults, actions, options) {
          ...
          function extractParams(data, actionParams) {
            ...
            forEach(actionParams, function (value, key) {
              ...
              ids[key] =
                value && value.charAt && value.charAt(0) === '@' ? lookupDottedPath(data, value.substr(1)) : value;
            });
            return ids;
          }
          ...
          forEach(actions, function (action, name) {
            var hasBody =
              action.hasBody === true || (action.hasBody !== false && /^(POST|PUT|PATCH)$/i.test(action.method));
