...
describe('DocsController', function () {
  ...
  angular.module('fake', []).value('$cookies', {}).value('NG_PAGES', {}).value('NG_NAVIGATION', {});
  ...
  beforeEach(
    module('fake', 'DocsController', function ($provide) {
  ...
  describe('afterPartialLoaded', function () {
    ...
    it('should update the Google Analytics with $location.path if currentPage is missing', inject(function (
      $window,
      $location
    ) {
      $window._gaq = [];
